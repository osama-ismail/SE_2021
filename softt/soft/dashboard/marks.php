...
?>
                  <tr>
                    ...
                    <td><?= $pro['mark_name'];?></td>
                    <td><?= $pro['mark'];?></td>
                    <td> <a class="btn btn-secondary" href="mark_update.php?proid=<?= $pro['mark_id'];?> ">تعديل العلامة</a></td>

                    <td><a href="deletemark.php?proid=<?=$pro['mark_id'];?>&proid1=<?= $pro['couse_id'];?> " class="btn btn-danger">delete mark</a></td>
