...
$sql = "SELECT * FROM `marksview` where `mark_id` = '$idd'"; 
...
if(isset($_POST['mark'])){
  ...
  $sql1 = "UPDATE `marks` SET `mark`='$mark' WHERE `mark_id`='$idd'"; 
  ...
  if ( $res1== 1){
    header("LOCATION:marks.php?proid=$c_id");
  ...
  <div class="content-wrapper">
    ...
    <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">  student name : <?php echo $data['first_name']." ".$data['last_name']    ?></h3>
              </div>
           
              <form action="mark_update.php"  method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                   
                  student name : <?php echo $data['first_name']." ".$data['last_name']    ?>
                  <br>
                  student number : <?php echo $data['id']  ?>
                  <br>
                  assigment name : <?php echo $data['mark_name']  ?>
                  <br>
                  current mark : <?php echo $data['mark'];   ?>
            ...
            <a href="student_reg.php?proid=<?= $data['couse_id'];?>">المسجلين في المساق </a>
            <br>
   <a href="marks.php?proid=<?= $data['couse_id'];?>">علامات المسجلين في المساق</a>
