...
$sql = "SELECT * FROM `marksview` where `couse_id`='$idd' and `id`='$ii' "; 
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Students marks</h1>
          </div><!-- /.col -->
...
?>
   ...
   <br>
   <a href="coursee.php?proid=<?= $idd;?>">العودة الى صفحة المساق </a>



      
   <span style="border: 1px solid; color:red; margin-left:10px;" id="val"></span>
<button onclick="updateSubTotal()">calculate</button>
...
function updateSubTotal() {
  ...
  document.getElementById("val").innerHTML = "sum= " + subTotal.toFixed(2);
}
